...
namespace ZXing
{
    /// <summary> class hierarchy to convert luminance data to 1 bit data. </summary>
    /// <remarks>
    /// Polymorphic algorithm, e.g. allowing a very expensive threshold technique
    /// for servers and a fast one for mobile.
    /// Also permits the implementation to vary,
    /// e.g. a JNI version for Android and a
    /// Java fallback version for other platforms.
    /// 
