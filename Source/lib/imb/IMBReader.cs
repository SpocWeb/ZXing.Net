...
namespace ZXing.IMB
{
    ...
    public sealed class ImbReader : OneDReader
    {
        ...
        public override BarCodeText DecodeRow(int rowNumber, BitArray row, IDictionary<DecodeHintType, object> hints)
        {
            ...
            int pixelStopOffset = _CurrentBitmap.Width - 1;
            int pixelBarLength = 0;
            int numBars = X.IsImb(row, ref pixelStartOffset, ref pixelStopOffset, ref pixelBarLength);
            if (numBars != NUM_BARS_IMB) {
                return null;
            }

            // create the two bitarrays to check top and bottom
            BitArray topRow = new BitArray(_CurrentBitmap.Width);
            BitArray botRow = new BitArray(_CurrentBitmap.Width);
            ...
            do
            {
                ...
                rowNumberTop--;
                topRow = _CurrentBitmap.GetBlackRow(rowNumberTop, topRow);
            } while (X.GetNumberBars(topRow, pixelStartOffset, pixelStopOffset, pixelBarLength) >= NUM_BARS_IMB);
            do
            {
                if (rowNumberBot >= _CurrentBitmap.Height - 1) {
                    return null;
                }
                rowNumberBot++;
                botRow = _CurrentBitmap.GetBlackRow(rowNumberBot, botRow);
            } while (X.GetNumberBars(botRow, pixelStartOffset, pixelStopOffset, pixelBarLength) >= NUM_BARS_IMB);

            List<int> listRow = new List<int>();
            List<int> listTop = new List<int>();
            List<int> listBot = new List<int>();
            X.FillLists(row, topRow, botRow, ref listRow, ref listTop, ref listBot, pixelStartOffset, pixelStopOffset);
            ...
            string trackingNumber = X.GetTrackingNumber(symbolCode);
    ...
    public static class X {
        ...
        static ushort BinaryStringToDec(string binary)
        {
        ...
        static string InvertedBinaryString(string binary)
        {
            string result = "";
        ...
        static bool GetCodeWords(out int[] codeWord, string imb
        ...
        static readonly IDictionary<int, int> TABLE1_CHECK;
        static readonly IDictionary<int, int> TABLE2_CHECK;
        ...
        static X()
        {
            ...
            TABLE1_CHECK = new Dictionary<int, int>(2000);
            TABLE2_CHECK = new Dictionary<int, int>(200);
            for (int k = 0; k < table1.Length; k++)
            {
                TABLE1_CHECK.Add(table1[k], k);
            }

            for (int k = 0; k < table2.Length; k++)
            {
                TABLE2_CHECK.Add(table2[k], k);
            }
        }

        static readonly int[] BAR_POS_A = { 2, 6, 13, 16, 21, 30, 34, 40, 45, 48, 52, 56, 62 };
        static readonly int[] BAR_POS_B = { 22, 18, 39, 41, 11, 57, 54, 50, 7, 32, 2, 62, 26 };
        static readonly int[] BAR_POS_C = { 40, 35, 57, 52, 49, 7, 24, 17, 3, 63, 29, 44, 12 };
        static readonly int[] BAR_POS_D = { 47, 5, 35, 39, 30, 42, 15, 60, 20, 10, 65, 54, 23 };
        static readonly int[] BAR_POS_E = { 20, 41, 46, 1, 8, 51, 29, 61, 34, 15, 25, 37, 58 };
        static readonly int[] BAR_POS_F = { 51, 25, 19, 64, 56, 4, 44, 31, 28, 36, 47, 11, 6 };
        static readonly int[] BAR_POS_G = { 33, 37, 21, 9, 17, 49, 59, 14, 64, 26, 42, 4, 53 };
        static readonly int[] BAR_POS_H = { 60, 14, 1, 27, 38, 61, 10, 24, 50, 55, 19, 32, 45 };
        static readonly int[] BAR_POS_I = { 27, 46, 65, 59, 31, 12, 16, 43, 55, 5, 9, 22, 36 };
        static readonly int[] BAR_POS_J = { 63, 58, 53, 48, 43, 38, 33, 28, 23, 18, 13, 8, 3 };
        static readonly int[][] BAR_POS = {BAR_POS_A, BAR_POS_B, BAR_POS_C, BAR_POS_D, BAR_POS_E, BAR_POS_F, BAR_POS_G, BAR_POS_H, BAR_POS_I, BAR_POS_J };

        static readonly char[] BAR_TYPE_A = { 'A', 'D', 'A', 'D', 'A', 'A', 'D', 'D', 'D', 'A', 'A', 'A', 'D' };
        static readonly char[] BAR_TYPE_B = { 'A', 'D', 'A', 'D', 'A', 'D', 'A', 'A', 'A', 'A', 'D', 'A', 'D' };
        static readonly char[] BAR_TYPE_C = { 'A', 'D', 'A', 'D', 'A', 'D', 'D', 'A', 'A', 'D', 'A', 'D', 'A' };
        static readonly char[] BAR_TYPE_D = { 'A', 'A', 'A', 'D', 'D', 'A', 'D', 'A', 'A', 'D', 'D', 'D', 'A' };
        static readonly char[] BAR_TYPE_E = { 'D', 'A', 'D', 'A', 'D', 'A', 'D', 'D', 'A', 'A', 'A', 'D', 'A' };
        static readonly char[] BAR_TYPE_F = { 'D', 'D', 'A', 'A', 'D', 'D', 'A', 'A', 'D', 'D', 'D', 'D', 'A' };
        static readonly char[] BAR_TYPE_G = { 'D', 'A', 'D', 'D', 'D', 'D', 'A', 'A', 'D', 'A', 'D', 'A', 'D' };
        static readonly char[] BAR_TYPE_H = { 'D', 'D', 'D', 'D', 'A', 'A', 'A', 'A', 'D', 'A', 'D', 'D', 'A' };
        static readonly char[] BAR_TYPE_I = { 'A', 'A', 'A', 'D', 'D', 'D', 'A', 'D', 'D', 'D', 'A', 'D', 'A' };
        static readonly char[] BAR_TYPE_J = { 'A', 'D', 'A', 'D', 'A', 'D', 'A', 'A', 'D', 'A', 'D', 'A', 'D' };
        static readonly char[][] BAR_TYPE = {BAR_TYPE_A, BAR_TYPE_B, BAR_TYPE_C, BAR_TYPE_D, BAR_TYPE_E, BAR_TYPE_F, BAR_TYPE_G, BAR_TYPE_H, BAR_TYPE_I, BAR_TYPE_J };
        ...
        public static string GetTrackingNumber(string imb)
        {

            // get codewords A-J
            if (!GetCodeWords(out var codeWord, imb, TABLE1_CHECK, TABLE2_CHECK
                , BAR_POS, BAR_TYPE))
            {
                // imb is upside down
                ...
                if (!GetCodeWords(out codeWord, invertedImb.ToString(), TABLE1_CHECK, TABLE2_CHECK
                    , BAR_POS, BAR_TYPE)) {
                    return null;
                }
            }
        ...
        public static void FillLists(BitArray row, BitArray topRow, BitArray botRow, ref List<int> listRow, ref List<int> listTop, ref List<int> listBot, int start, int stop) // list: 1=black  0=white
        {
        ...
        public static int IsImb(BitArray row, ref int pixelStartOffset, ref int pixelStopOffset, ref int pixelBarLength)
        {
            int width = row.Size;
        ...
        public static int GetNumberBars(BitArray row, int start, int stop, int barWidth)
        {
            const bool isWhite = false;
            bool insideBar = false;
            int countBars = 0;
